...
```{r eval=TRUE, echo=TRUE}
  ...
  qplot(x=Pesticide, y=treatbcf, fill=factor(SoilType), xlab="", ylab="Bioconcentration Factor", 
        ...
        theme_bw() +  scale_x_discrete(breaks=c("ATZTOT", "FipTOT", "Imid", "Pendi", "TNDTOT"),  labels=pesticides) + guides(fill=guide_legend(title="Soil Type")) + theme(legend.position="top")
```
