...
Introduction
========================================================
Data set, statistical analyses, graphics and inference concerning effect of organic carbon in soil on dermal bioconcentration in amphibians. Analytes include active ingredients for commonly used pesticides (atrazine, imidacloprid, fipronil, triadimenon, pendimethalin).
...
Generate figure as png for the manuscript.
```{r eval=TRUE, echo=TRUE}
...
frog.soil.total.ai$Pesticide <- factor(frog.soil.total.ai$Pesticide, levels = c("Imid", "ATZTOT", "TNDTOT", "FipTOT", "Pendi"))
#levels(frog.soil.total.ai$Pesticide) <- c("Imid", "ATZTOT", "TNDTOT", "FipTOT", "Pendi")
png(paste(frogsoildir,"rvm2016_fig1.png", sep=""))
  pesticides <- c("Imidacloprid", "Atrazine", "Triadimenon", "Fipronil", "Pendimethalin")
